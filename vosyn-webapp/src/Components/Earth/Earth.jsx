...
function Earth(props) {
    ...
    return (
        <>
            <mesh ref={earthRef} scale={[earthScale, earthScale, earthScale]} position={[0, -1, 0]}>
                <sphereGeometry args={[1, 32, 32]} />
                <meshPhongMaterial specularMap={new TextureLoader().load(EarthSpecularMap)} />
...
function EarthScene(props) {
    ...
    <Suspense fallback={<div className='loading'>Loading Earth...</div>}>
        ...
        {/* {selectedContinent && <Sidebar continent={selectedContinent} />} */}
    </>
